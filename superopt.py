...
from pastcycle import pastcycle
from optFuncCycle import optFuncCycle
pair="USD_JPY"
...
for ii in range(0,periods):
    Data=(pastcycle(pair,"M15",50+ii))
    A.append(Data[:-1*(ii*100)])
...
#space  = [Real(0.05, 0.6, name='Threshold'),
#          Real(0.5, 3.5, name='stoploss'),
#          Real(1.5, 5, name='profitmulti'),
#          Real(1, 3, name='trainmulti')]
...
res=gbrt_minimize(optFuncCycle, space, n_calls=50000, random_state=0,n_random_starts=10, verbose='True', n_jobs=1 )
