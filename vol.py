...
#        temp.append(normout(inputPre[:,loopNum*jj+8]))
#        temp.append(hundred(inputPre[:,loopNum*jj+10]))
        temp.append((inputPre[:,loopNum*jj+11]))
#        temp.append(hundred(inputPre[:,loopNum*jj+12]))
#        temp.append(hundred(inputPre[:,loopNum*jj+13]))    
#        temp.append(normout(inputPre[:,loopNum*jj+14:loopNum*jj+17]))
#        temp.append(twohundred(inputPre[:,loopNum*jj+17]))
...
##            tempOut.append(0)
    ...
    for ii in range(starttraining,endtraining):
        if history1[ii+1,3]>history1[ii,3]:
            if history1[ii,3]-history1[ii+1,2]<=spread:
                tempOut.append(1)
                tempOut.append(0)
                tempOut.append(0)
            if history1[ii,3]-history1[ii+1,2]>spread and history1[ii,3]-history1[ii+1,2]<=2*spread:
                tempOut.append(0)
                tempOut.append(1)
                tempOut.append(0)    
            if history1[ii,3]-history1[ii+1,2]>2*spread:
                tempOut.append(0)
                tempOut.append(0)
                tempOut.append(1)   
        if history1[ii+1,3]<=history1[ii,3]:
            if history1[ii+1,1]-history1[ii,3]<=spread:
                tempOut.append(1)
                tempOut.append(0)
                tempOut.append(0)
            if history1[ii+1,1]-history1[ii,3]>spread and history1[ii+1,1]-history1[ii,3]<=2*spread:
                tempOut.append(0)
                tempOut.append(1)
                tempOut.append(0)    
            if history1[ii+1,1]-history1[ii,3]>2*spread:
                tempOut.append(0)
                tempOut.append(0)
                tempOut.append(1)   
...
for ii in range(starttraining,endtraining):
    if history1[ii+1,3]>history1[ii,3]:
        stopData.append(((history1[ii,3]-history1[ii+1,2])/spread))
    if history1[ii+1,3]<=history1[ii,3]:
        stopData.append(((history1[ii+1,1]-history1[ii,3])/spread))
