...
#    history.append(algo.getpast.getpast(pairIn,"H1"))
...
#    for kk in range(0,len(history)):
    ...
    normIn, normOut = inOut(inputs, adjustedStart, endtraining, 1,targetHistory)    
