# -*- coding: utf-8 -*-
"""
Created on Sun Jun 17 10:25:21 2018
...
beta=0.005
#    periods=20
#0.4576895362095635 0.699247770960956 4.420670981970803 1.2525281684299667


#    spread=getSpread.getSpread(pair)
threshold=0.4576895362095635
stoploss=0.699247770960956
predIn=2
n=4.420670981970803
m=1.2525281684299667
...
#    predictions=notraining(Data,pair,1, hidden, layers_stacked_count, beta)
    profit = tradeModel(predictions, Data, threshold,spread, stoploss,n)+profit
profit=-profit
#    return -profit